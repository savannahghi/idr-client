...
class BaseDataSinkStream(
    DataSinkStream[_UM, _UC, _CD], Generic[_UM, _UC, _CD], metaclass=ABCMeta,
):
    """
...
class BaseDataSourceStream(
    DataSourceStream[_EM, _RD], Generic[_EM, _RD], metaclass=ABCMeta,
):
    """
    ...
    _data_source: DataSource[_EM, _RD] = field()
