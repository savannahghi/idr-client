...
class Config(metaclass=ABCMeta):
    ...
    def of(
        ...
        """
        Create a new :class:`Config` instance. The settings to use are passed
        as a mapping with the setting names as the keys and the setting values
        as the values of the mapping.
    ...
    def of_awaiting_setup(err_msg: str | None = None) -> Config:
        ...
        is not yet set up. Any attempt to access settings from the returned
